...
while ($row = $result->fetch_assoc()) {
  $car_img[$row['carid']] = "images/car/" . $row['carimage'];
}
// cartype selection.
...
<body>
  <div class="topnav">
    <a class="fa fa-home" href="mainPage.php"> Home</a>
    <a class="fa fa-book" href="Cards.php"> My Cards</a>
    <a style="float: right; padding: 40px 66px; cursor: pointer; text-decoration: none;" class="fa fa-power-off topnav"
      onclick="onOffDrop()">
    </a>
  ...
  <div class="filter-section">
    <h1>Filter</h1>
    <form class="filter-content" action="#" method="post">
      <div class="inp">
        <p id="brandcar">Brand: </p>
      ...
      <div class="inp">
        ...
        <select class="selections" id="types" name="types">
          <option value="All types">All types</option>
        </select>
      </div>
      <div class="inp">
        <p>Start Date: </p>
        <input class="selections" type="date" name="startdate" value="">
      </div>
      <div class="inp">
        <p>End Date: </p>
        <input class="selections" type="date" name="enddate" value="">
      </div>
      <div class="inp">
        <p id="CarCity">City: </p>
      ...
      <input class="filter-btn" type="submit"name="submitbrand" value="Filter">
    </form>
  </div>
