...
<?php
    ...
    $seatErr = $doorErr = $acErr = $gearErr = $brandErr = $typeErr = $valueErr = $addressErr = $imageErr = "";
    ...
    if (isset($_POST["add"])) {
      ...
      if (empty($seatErr) && empty($doorErr) && empty($acErr) && empty($gearErr) &&
          empty($brandErr) && empty($colorErr) && empty($valueErr) && empty($addressErr) && empty($imageErr)){
            $sql = "INSERT INTO cars(carbrand, cartype, carvalue, carinfo, caraddress, carimage, statu)
            VALUES('$brand','$type','$value','$brand','$address','$image','1')";
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="change">
        ...
        <p> Type: <input type="text" name="Type" placeholder="enter here"> <span> * <?php echo $typeErr; ?></span> </p>
