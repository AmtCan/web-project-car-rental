...
<?php
  ...
  if (isset($_POST["payment"])) {
    $sql = "INSERT INTO reservation(startdate, enddate, city, cost, carids, userid)
            VALUES('$start','$end','$city','$total','$carid','$userid')";
...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="topnav">
      ...
      <div class="valuecon">
        <h1 style="margin-left: 10px;">Total: <?php echo $total; ?></h1>
        ...
        <li style="margin-left: 10px; margin-bottom:10px;">Car: <?php echo $brand; ?></li>
      </div>
  </body>
</html>
